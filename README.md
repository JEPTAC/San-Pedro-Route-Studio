...
## Solución para cuando no aparece "Esta pestaña"

Esta versión agrega opciones de captura para que Chrome/Edge prefieran la pestaña actual:
...
Si aun así no aparece, abre la app desde GitHub Pages en una pestaña normal de Chrome/Edge. No uses la PWA instalada ni abras el HTML como archivo local.
